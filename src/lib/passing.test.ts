...
describe('simultaneous passing', () => {
  it.each([
    ...
    ['poisoned-apple', 'left', 2],
    ['odds-and-evens', 'right', 2],
    ['single-fairy', 'left', 1],
    ['prince-rings-twice', 'split', 2],
    ['midnight-makeover', 'left', 3],
    ['pass-the-bouquet', 'left', 3],
    ['upside-down', 'left', 2],
    ['bathroom-break', 'left', 2],
    ['dancing-queens', 'right', 2]
