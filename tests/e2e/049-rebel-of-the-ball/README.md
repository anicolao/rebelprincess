...
![The complete shared deal visibly contains the nine in-deck Princes and the Frog required for Rebel of the Ball](./screenshots/000-rebel-ready-desktop.png)
...
![All 36 ordinary UI clicks finish the round with Jo holding every one of the ten required target cards](./screenshots/002-rebel-complete-desktop.png)
