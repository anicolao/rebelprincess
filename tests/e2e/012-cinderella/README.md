...
## Alex leads Fairies 4 into Cinderella’s reversed trick

![Alex leads Fairies 4 into Cinderella’s reversed trick](./screenshots/002-cinderella-lead-played-desktop.png)
...
## Jo follows with Fairies 2 and both ranks remain visible

![Jo follows with Fairies 2 and both ranks remain visible](./screenshots/003-cinderella-second-card-played-desktop.png)
...
## Jo takes the reversed trick with the lowest led-suit card, Fairies 2

![Jo takes the reversed trick with the lowest led-suit card, Fairies 2](./screenshots/004-cinderella-lowest-card-wins-desktop.png)
