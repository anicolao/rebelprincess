...
![Clicking Pocahontas opens a leader button for every player](./screenshots/000-pocahontas-leader-prompt-desktop.png)
...
![The chooser click changes the shared leader immediately](./screenshots/001-pocahontas-clicks-new-leader-desktop.png)
